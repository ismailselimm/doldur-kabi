              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildExpandableSection(
                      '10. Puan Sistemi Nasıl Çalışır?',
                      'Uygulamada yaptığınız her paylaşım, mama doldurma ve besleme noktası ekleme gibi eylemler size puan kazandırır. '
                          'Bu puanlar sayesinde en aktif kullanıcılar arasında yer alabilir ve özel rozetler kazanabilirsiniz.',
                    ),
                    _buildExpandableSection(
                      '11. Kullanıcı Profili Nasıl Düzenlenir?',
                      'Profilinizi güncellemek için sağ üst köşedeki "Profil" sekmesine gidin. '
                          'Buradan profil fotoğrafınızı değiştirebilir, ad-soyad bilgilerinizi ve iletişim tercihlerinizi düzenleyebilirsiniz.',
                    ),
                    _buildExpandableSection(
                      '12. Uygulama Geliştirmelerine Nasıl Katkı Sağlayabilirim?',
                      'Geliştirme sürecine destek olmak isterseniz "Bize Ulaşın" sayfasından öneri, hata bildirimi ya da gönüllü destek talebi gönderebilirsiniz. '
                          'Topluluktan gelen geri bildirimler bizim için çok değerli.',
                    ),
